    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={{ flex: 1, padding: 16, gap: 12, justifyContent: "center" }}>
        ...
        <TextInput
          ...
          style={{ borderWidth: 1, borderColor: "#ccc", padding: 10, borderRadius: 8, backgroundColor: '#fff' }}
        />
        ...
        <View style={{ position: "relative" }}>
          <TextInput
            ...
            style={{ borderWidth: 1, borderColor: "#ccc", padding: 10, borderRadius: 8, paddingRight: 48, backgroundColor: '#fff' }}
          />
          <Pressable
