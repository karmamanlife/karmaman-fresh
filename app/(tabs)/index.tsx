...
// ============================================
// MACRO BREAKDOWN ITEM COMPONENT
// ============================================
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollContent} contentContainerStyle={styles.content}>
        {/* Nutrition Card with Macro Rings */}
          ...
          <CardContent>
            <View style={styles.nutritionContainer}>
              ...
              <View style={styles.ringsContainer}>
                {/* Center white calorie ring - MUST BE FIRST */}
            ...
            <View style={styles.workoutOverlay}>
              ...
              <Pressable style={styles.workoutButton} onPress={() => router.push('/workout/today')}>
                <Text style={styles.workoutButtonText}>
                  {workoutComplete ? 'Nice Work!!' : "Let's Go!"}
                </Text>
              </Pressable>
            </View>
          </CardContent>
...
const styles = StyleSheet.create({
  ...
  // CRITICAL: Center white calorie ring
  calorieRing: {
    width: 120,
    height: 120,
    borderRadius: 60,
